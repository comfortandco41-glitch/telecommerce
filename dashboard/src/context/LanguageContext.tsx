...
const translations = {
  en: {
    ...
    auth: {
      ...
      verifyOtpSubtitle: "A 6-digit verification code was sent to your email",
      otpCode: "Verification Code",
      verifyBtn: "Verify & Access",
      verifying: "Verifying...",
      forgotPasswordTitle: "Reset Your Password",
      forgotPasswordSubtitle: "Enter your registered email to request a recovery code",
    ...
    authShowcase: {
      ...
      receiptTitle: "24/7 Automated Store",
      receiptDesc: "Your shop stays open 24/7 on Telegram. Automatically capture buyer orders, questionnaire details, and payments anytime.",
  ...
  my: {
    ...
    auth: {
      ...
      verifyOtpTitle: "အတည်ပြုကုဒ် ထည့်သွင်းပါ",
      verifyOtpSubtitle: "၆ လုံးပါသော အတည်ပြုကုဒ်ကို သင့်အီးမေးလ်သို့ ပို့ထားပြီးပါပြီ",
      otpCode: "အတည်ပြုကုဒ်",
      verifyBtn: "အတည်ပြုပြီး ဆက်သွားမည်",
      verifying: "အတည်ပြုနေသည်...",
      forgotPasswordTitle: "လျှို့ဝှက်နံပါတ် ပြန်ပြင်ရန်",
      forgotPasswordSubtitle: "လျှို့ဝှက်နံပါတ် ပြန်ပြင်ရန် ကုဒ်တောင်းယူမည့် အီးမေးလ်ကို ရိုက်ထည့်ပါ",
      sendResetBtn: "ကုဒ် ပို့ရန် တောင်းဆိုမည်",
      sendingReset: "ကုဒ် ပို့နေသည်...",
      resetPasswordTitle: "လျှို့ဝှက်နံပါတ် အသစ်သတ်မှတ်မည်",
    ...
    authShowcase: {
      ...
      receiptTitle: "၂၄/၇ ဖွင့်လှစ်ထားသော ဆိုင်စနစ်",
      receiptDesc: "တယ်လီဂရမ်တွင် သင့်ဆိုင်ကို ၂၄ နာရီပတ်လုံး ဖွင့်လှစ်ထားပြီး ဝယ်ယူသူများ၏ အော်ဒါနှင့် ငွေပေးချေမှုများကို အလိုအလျောက် လက်ခံဆောင်ရွက်ပေးမည်။",
